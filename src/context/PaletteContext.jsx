...
export const PALETTES = [
  ...
  { name:"ocean",bg:["#0f1923","#0a1628","#0d1f35","#111e2e"],accent:"#4a8bc2",textMain:"#c8dae8",textSoft:"rgba(200,218,232,0.78)",textFaint:"rgba(200,218,232,0.52)",border:"rgba(200,218,232,0.16)",glass:"rgba(255,255,255,0.10)",shadow:"rgba(74,139,194,0.3)",shadowHover:"rgba(74,139,194,0.5)",orbGlow:"rgba(74,139,194,0.5)" },
  { name:"cosmos",bg:["#0d0a18","#12081f","#1a0e2a","#0f0b1e"],accent:"#9b6fdf",textMain:"#d4c8e8",textSoft:"rgba(212,200,232,0.78)",textFaint:"rgba(212,200,232,0.52)",border:"rgba(212,200,232,0.16)",glass:"rgba(255,255,255,0.09)",shadow:"rgba(155,111,223,0.3)",shadowHover:"rgba(155,111,223,0.5)",orbGlow:"rgba(155,111,223,0.5)" },
  ...
  { name:"ember",bg:["#1a0f0a","#201008","#2a1510","#1c110c"],accent:"#d4845a",textMain:"#e8d0c0",textSoft:"rgba(232,208,192,0.78)",textFaint:"rgba(232,208,192,0.52)",border:"rgba(232,208,192,0.16)",glass:"rgba(255,255,255,0.09)",shadow:"rgba(212,132,90,0.3)",shadowHover:"rgba(212,132,90,0.5)",orbGlow:"rgba(212,132,90,0.5)" },
  ...
  { name:"void",bg:["#060608","#0a0a10","#08080e","#050507"],accent:"#8888b0",textMain:"#c0c0d4",textSoft:"rgba(192,192,212,0.78)",textFaint:"rgba(192,192,212,0.52)",border:"rgba(192,192,212,0.14)",glass:"rgba(255,255,255,0.08)",shadow:"rgba(136,136,176,0.25)",shadowHover:"rgba(136,136,176,0.45)",orbGlow:"rgba(192,192,212,0.4)" },
]
